...
<body class="bg-gray-50 font-sans antialiased" x-data="{ sidebarOpen: false }">
        ...
        <nav class="mt-8 px-4">
            @if (auth()->user()->isAdmin())
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                ...
                <a href="{{ route('admin.pegawai.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.pegawai.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.periode.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.periode.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.evaluasi.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.evaluasi.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.kriteria.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.kriteria.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.hasil.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.hasil.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.laporan.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.laporan.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @else
                ...
                <a href="{{ route('pegawai.dashboard') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('pegawai.dashboard') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('pegawai.evaluasi.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('pegawai.evaluasi.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
                        </path>
                ...
                <a href="{{ route('pegawai.history.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition-all duration-200 {{ request()->routeIs('pegawai.history.*') ? 'bg-primary-50 text-primary-600 shadow-sm border-r-4 border-primary-600' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Profile Link (untuk semua user) -->
            <div class="mt-8 pt-4 border-t border-gray-200">
                <a href="{{ route('profile.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition-all duration-200 {{ request()->routeIs('profile.*') ? 'bg-gray-100 text-gray-900 shadow-sm' : '' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="lg:pl-64">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200 fixed top-0 right-0 left-0 lg:left-64 z-40">
            <div class="flex items-center justify-between h-20 px-8">
                ...
                <button @click="sidebarOpen = true"
                    class="lg:hidden text-gray-500 hover:text-gray-700 transition-colors p-2 rounded-lg">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex-1 lg:flex-none">
                    <h1 class="text-xl font-semibold text-gray-900 lg:hidden">@yield('title', 'Dashboard')</h1>
        ...
        <main class="pt-24 px-8 pb-8">
            ...
            @if (session('error'))
                <div class="mb-8 bg-danger-50 border border-danger-200 rounded-xl p-4" x-data="{ show: true }"
                    x-show="show" x-transition>
                    <div class="flex items-center justify-between">
                        <div class="flex">
                        ...
                        <button @click="show = false" class="text-danger-400 hover:text-danger-600 transition-colors">
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
